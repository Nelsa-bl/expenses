...
function Index() {
  ...
  (0, import_react.useEffect)(() => {
    const getExpensesMap = async () => {
      try {
        ...
        setIsLoading(false);
        setExpenses((data == null ? void 0 : data.items) || []);
      } catch (err) {
        let message;
  ...
  const showExpense = (expenses2) => {
    ...
    }, /* @__PURE__ */ React.createElement("h2", null, expense.name), /* @__PURE__ */ React.createElement("p", null, "Net: ", formatCurrency(Number(expense.net))), /* @__PURE__ */ React.createElement("p", null, "Tax: ", formatCurrency(Number(expense.tax))), /* @__PURE__ */ React.createElement("p", null, "Gross: ", formatCurrency(calcGross(expense.net, expense.tax))), /* @__PURE__ */ React.createElement("span", {
      className: "fav-icon",
      onClick: () => {
...
//# sourceMappingURL=/build/routes/index-TMXHAER6.js.map
