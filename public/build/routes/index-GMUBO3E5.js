...
function Index() {
  ...
  }, "Favorites (", favorites.length, ")")), isLoading ? /* @__PURE__ */ React.createElement("p", null, "Loading...") : /* @__PURE__ */ React.createElement(React.Fragment, null, showFavorites ? showExpense(expenses.filter((expense) => favorites.some((favorite) => favorite.id === expense.id))) : showExpense(expenses), /* @__PURE__ */ React.createElement("h3", null, "Total expenses: ", formatCurrency(calcTotal))));
}
export {
  Index as default
};
//# sourceMappingURL=/build/routes/index-GMUBO3E5.js.map
