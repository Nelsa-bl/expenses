...
function Index() {
  ...
  const calcTotal = filteredExpenses.reduce((sum, exp) => {
  ...
  const toggleFavorite = (id) => {
    ...
    if (favoriteIndex !== -1) {
      ...
      setFavorites((prevFavorites) => [...prevFavorites, expenseToAdd.id]);
    }
  };
...
//# sourceMappingURL=/build/routes/index-2BEDVC67.js.map
