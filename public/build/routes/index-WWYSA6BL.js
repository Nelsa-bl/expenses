...
function Index() {
  ...
  const showExpense = (expenses2) => {
    ...
    }, favorites.some((favorite) => favorite.id === expense.id) ? "\u2764\uFE0F" : "\u{1F90D}"), expense.name), /* @__PURE__ */ React.createElement("p", null, "Net: ", formatCurrency(expense.net)), /* @__PURE__ */ React.createElement("p", null, "Tax: ", formatCurrency(expense.tax)), /* @__PURE__ */ React.createElement("p", null, "Gross: ", calcGross(expense.net, expense.tax))));
  };
